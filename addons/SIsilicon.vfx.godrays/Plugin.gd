...
func _enter_tree() -> void:
	...
	add_custom_type("GodRays", "Node3D", GodRays, preload("GodRays.svg"))
	...
	create_project_setting(project_settings+"dither_amount", 1.0, TYPE_FLOAT, "The amount of noise to add to the godrays.")
